...
export async function getAdminOverview() {
    const [usersCount, verifiedUsersCount, googleUsersCount, feedbackCount, ratingAggregate, feedbackByTypeRows,] = await Promise.all([
        prisma.user.count(),
    ...
    const feedbackByType = Object.fromEntries(FEEDBACK_TYPES.map((type) => [type, 0]));
